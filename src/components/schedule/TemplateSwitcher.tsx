  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-[#1a1a24] border border-white/[0.08] rounded-xl hover:border-white/20 transition-all duration-150"
      >
      ...
      {isOpen && (
        <div className="absolute left-0 z-50 mt-1 min-w-[220px] bg-[#1a1a24] border border-white/[0.12] rounded-xl shadow-xl overflow-hidden">
