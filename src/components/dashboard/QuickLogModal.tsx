        ...
        {step === 1 && (
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="flex flex-col items-center gap-2 p-4 bg-[#0f0f13] border border-white/[0.08] rounded-lg hover:border-[#3b82f6]/40 hover:bg-[#3b82f6]/5 transition-all duration-150"
            >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-[#0f0f13] border border-white/[0.08] rounded-md px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#ef4444]/50 resize-none"
              />
            </div>
