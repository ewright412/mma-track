...
CREATE INDEX IF NOT EXISTS idx_techniques_discipline ON techniques(discipline);
CREATE INDEX IF NOT EXISTS idx_techniques_category ON techniques(category);
CREATE INDEX IF NOT EXISTS idx_techniques_difficulty ON techniques(difficulty);
...
CREATE INDEX IF NOT EXISTS idx_technique_practice_logs_user_id ON technique_practice_logs(user_id);
CREATE INDEX IF NOT EXISTS idx_technique_practice_logs_technique_id ON technique_practice_logs(technique_id);
